...
class TestGrafo(unittest.TestCase):
    ...
    def setUp(self):
        ...
        #Arvore DFS do grafo da paraiba comecando com vertice C
        self.g_p_dfs = MeuGrafo()

        # Criando na árvore DFS de predição todos os vértices do grafo inicial
        for v in self.g_p.vertices:
            self.g_p_dfs.adiciona_vertice(v.rotulo)
        # Adiciona apenas as arestas que fazem parte da árvore DFS
        # Não adicionar as arestas de retorno
        self.g_p_dfs.adiciona_aresta('a1', 'J', 'C')
        self.g_p_dfs.adiciona_aresta('a2', 'C', 'E')
        self.g_p_dfs.adiciona_aresta('a3', 'C', 'E')
        self.g_p_dfs.adiciona_aresta('a4', 'C', 'P')
        self.g_p_dfs.adiciona_aresta('a5', 'C', 'P')
        self.g_p_dfs.adiciona_aresta('a6', 'C', 'M')
        self.g_p_dfs.adiciona_aresta('a7', 'C', 'T')
    ...
    def test_dfs(self):
        # Testando a DFS a partir do vértice "J"
        resultado_j = self.g_p.dfs("J")
        resultado_esperado_j = ['a1', 'a3', 'a4', 'a7', 'a8', 'a9']

        resultado_j = self.g_p.dfs("E")
        resultado_esperado_j = ['a2', 'a1', 'a4', 'a6', 'a8', 'a9']

        resultado_j = self.g_p.dfs("P")
        resultado_esperado_j = ['a4', 'a1', 'a2', 'a6', 'a8', 'a9']

        resultado_j = self.g_p.dfs("M")
        resultado_esperado_j = ['a6', 'a1', 'a2', 'a4', 'a7', 'a9']

        resultado_j = self.g_p.dfs("T")
        resultado_esperado_j = ['a7', 'a1', 'a2', 'a4', 'a6', 'a9']

        resultado_j = self.g_p.dfs("Z")
        resultado_esperado_j = ['a9', 'a7', 'a1', 'a2', 'a4', 'a6']

        resultado_j = self.g_p.dfs("C")
        resultado_esperado_j = ['a1', 'a2', 'a4', 'a6', 'a7', 'a8', 'a9']
